...
namespace MyGameplayTags
{
	...
	// 배틀 아이템 쿨타임 (1~4번 슬롯)
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Item_1);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Item_2);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Item_3);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Item_4);
	
	// 인벤토리 메시지
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Message_Inventory_Updated);
	
	// 인풋 태그
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_UI_Inventory);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Item_1);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Item_2);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Item_3);
	MYCPPPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Item_4);
}
